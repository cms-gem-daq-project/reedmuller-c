.. xhal documentation master file, created by
   sphinx-quickstart on Tue Mar 24 12:35:55 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

======================
Reed--Muller C Library
======================
...
.. toctree::
   :maxdepth: 1
   :caption: reedmuller library API
...
.. toctree::
   ...
   reedmuller-c (this site) <http://0.0.0.0:8000/SITE_ROOT/docs/api/reedmuller-c/latest>
